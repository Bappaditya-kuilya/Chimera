...
import * as logFormats from "./log-formats.test.js";
...
runSuites([identity, ingest, kernel, discovery, hardening, runtime, lan, replay, vault, properties, accessLog, logFormats, server]);
